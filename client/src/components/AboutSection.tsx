      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <NavLink to={"/about"} className="bg-sky-600 hover:bg-sky-800 text-white font-semibold py-3 px-8 rounded-md transition duration-300 transform hover:scale-105">
              Learn About Us
            </NavLink>
          </div>
